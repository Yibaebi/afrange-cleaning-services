      ...
      <article className="other-services--container">
        ...
        <section className="other-services--section">
          <div>
            ...
            <h2>Hang Dry </h2>
            <p>
              Perfect for delicates, activewear, and other clothing that should
              avoid heat from the dryer. Machine-washed, hung to dry, and
              returned neatly folded!
            </p>
            <button className="primary-button">
              See Pricing <i className="fas fa-arrow-right ml-2"></i>
            </button>
        ...
        <section className="other-services--section">
          <div>
            ...
            <p>
              ...
              the important natural oils of the leather so they look their best
              and last for years.
            </p>
            <button className="primary-button">
              See Pricing <i className="fas fa-arrow-right ml-2"></i>
        ...
        <figure>
          <img
            src="https://images.unsplash.com/photo-1501470877489-8e53c465f30d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=335&q=80"
            alt=""
          />
        </figure>
        <section className="other-services--section">
